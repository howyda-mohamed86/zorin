...
return [
    ...
    */
    ...
    'api' => [
        'product' => [
            ...
            "time_up" => ':title is not available at from :from to :to',
            "option_not_exists" => "Option :id not exists with product :title",
            "option_not_available" => ":title not available",
    ...
    */
    ...
    'attributes' => [
        ...
        'is_approved_conditions' => 'Approved Conditions',
