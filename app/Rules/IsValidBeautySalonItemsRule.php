...
use Tasawk\Api\V1\Customer\CreateOrder\Design\Mappers\BeautySalonMapper;
...
class IsValidBeautySalonItemsRule implements ValidationRule {
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void {
        foreach ($value as $option) {
             ...
             * */
            $mapper_item = BeautySalonMapper::getMapper()->$id();
