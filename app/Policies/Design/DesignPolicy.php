...
class DesignPolicy
{
    ...
    {
        return $user->can('view_any_design::design');
    }
     ...
     *
     * @param  \Tasawk\Models\User  $user
     * @param  \Tasawk\Models\Design\Design  $design
     * @return bool
     */
    ...
    {
        return $user->can('create_design::design');
    }
    ...
    {
        return $user->can('update_design::design');
    }
    ...
    {
        return $user->can('delete_design::design');
    }
    ...
    {
        return $user->can('delete_any_design::design');
    }
