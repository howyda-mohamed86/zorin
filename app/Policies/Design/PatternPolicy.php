...
namespace Tasawk\Policies\Design;
...
class PatternPolicy
{
    ...
    {
        return $user->can('view_any_design::pattern');
    }
     ...
     *
     * @param  \Tasawk\Models\User  $user
     * @param  \Tasawk\Models\Design\Pattern  $pattern
     * @return bool
     */
    ...
    {
        return $user->can('create_design::pattern');
    }
    ...
    {
        return $user->can('update_design::pattern');
    }
    ...
    {
        return $user->can('delete_design::pattern');
    }
    ...
    {
        return $user->can('delete_any_design::pattern');
    }
