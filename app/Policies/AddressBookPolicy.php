...
class AddressBookPolicy
{
    ...
    {
        return $user->can('view_any_crm::address::book');
    }
     ...
     *
     * @param  \Tasawk\Models\User  $user
     * @param  \Tasawk\Models\AddressBook  $addressBook
     * @return bool
     */
    ...
    {
        return $user->can('create_crm::address::book');
    }
    ...
    {
        return $user->can('update_crm::address::book');
    }
    ...
    {
        return $user->can('delete_crm::address::book');
    }
    ...
    {
        return $user->can('delete_any_crm::address::book');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, AddressBook $addressBook): bool
    {
