...
class ManagerPolicy
{
    ...
    {
        return $user->can('view_any_employees::manager');
    }
     ...
     *
     * @param  \Tasawk\Models\User  $user
     * @param  \Tasawk\Models\Manager  $manager
     * @return bool
     */
    ...
    {
        return $user->can('create_employees::manager');
    }
    ...
    {
        return $user->can('update_employees::manager');
    }
    ...
    {
        return $user->can('delete_employees::manager');
    }
    ...
    {
        return $user->can('delete_any_employees::manager');
    }
