...
class ServiceProviderPolicy
{
    ...
    {
        return $user->can('view_any_providers::service::provider');
    }
     ...
     *
     * @param  \Tasawk\Models\User  $user
     * @param  \Tasawk\Models\ServiceProvider  $serviceProvider
     * @return bool
     */
    ...
    {
        return $user->can('create_providers::service::provider');
    }
    ...
    {
        return $user->can('update_providers::service::provider');
    }
    ...
    {
        return $user->can('delete_providers::service::provider');
    }
    ...
    {
        return $user->can('delete_any_providers::service::provider');
    }
