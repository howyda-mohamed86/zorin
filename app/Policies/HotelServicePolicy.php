...
class HotelServicePolicy
{
    ...
    {
        return $user->can('view_any_hotels::hotel::services');
    }
     ...
     *
     * @param  \Tasawk\Models\User  $user
     * @param  \Tasawk\Models\HotelService  $hotelService
     * @return bool
     */
    public function view(User $user, HotelService $hotelService): bool
    {
        return $user->can('view_hotels::hotel::services');
    }
    ...
    {
        return $user->can('create_hotels::hotel::services');
    }
    ...
    {
        return $user->can('update_hotels::hotel::services');
    }
    ...
    {
        return $user->can('delete_hotels::hotel::services');
    }
    ...
    {
        return $user->can('delete_any_hotels::hotel::services');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, HotelService $hotelService): bool
    {
