...
class ContactTypePolicy
{
    ...
    {
        return $user->can('view_any_content::contact::type');
    }
     ...
     *
     * @param  \Tasawk\Models\User  $user
     * @param  \Tasawk\Models\ContactType  $contactType
     * @return bool
     */
    ...
    {
        return $user->can('create_content::contact::type');
    }
    ...
    {
        return $user->can('update_content::contact::type');
    }
    ...
    {
        return $user->can('delete_content::contact::type');
    }
    ...
    {
        return $user->can('delete_any_content::contact::type');
    }
