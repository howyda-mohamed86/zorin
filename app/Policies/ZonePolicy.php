...
class ZonePolicy
{
    ...
    {
        return $user->can('view_any_locations::zone');
    }
    ...
    {
        return $user->can('create_locations::zone');
    }
    ...
    {
        return $user->can('update_locations::zone');
    }
    ...
    {
        return $user->can('delete_locations::zone');
    }
    ...
    {
        return $user->can('delete_any_locations::zone');
    }
