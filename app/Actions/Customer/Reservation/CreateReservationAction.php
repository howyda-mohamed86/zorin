...
use Tasawk\Http\Resources\Api\Hotel\Reservation\ReservationResource;
...
class CreateReservationAction
{
    ...
    public function handle(ModelsUser $user, HotelService $service, $request, $data = [])
    {
        $cart = app('cart');
        $resource = ReservationResource::make($service)->toArray(request());
        ...
        return $user->reservations()->create([
            ...
            'customer_id' => $user->id,
            'service_provider_id' => $service->hotel->service_provider_id,
            'category_type' => 'hotel',
