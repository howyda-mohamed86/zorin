...
namespace Tasawk\Http\Requests\Api\Customer\Order\BeautySalon;

use Illuminate\Foundation\Http\FormRequest;
use Tasawk\Rules\IsValidBeautySalonItemsRule;
...
class CartDetailsRequest extends FormRequest {
    ...
    public function rules(): array {
        return [
            'items' => ['required', 'array', new IsValidBeautySalonItemsRule()]
        ];
    }
