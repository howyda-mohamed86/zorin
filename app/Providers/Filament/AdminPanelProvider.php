    ...
    public function panel(Panel $panel): Panel
    {
        ...
        return $panel
            ...
            ->navigationGroups([
                ...
                NavigationGroup::make()
                    ->label(fn (): string => __('menu.service_providers')),
                NavigationGroup::make()
                    ->label(fn (): string => __('menu.hotels')),
                NavigationGroup::make()
                    ->label(fn (): string => __('menu.categories')),
                NavigationGroup::make()
            ...
            //     return Storage::disk('public')->exists($settings->app_logo ?? 'null') ? asset($settings->app_logo) : 'https://awscdn1.tasawk.com/wp-content/uploads/2018/08/logo-d.png';
            // })
            ->brandName(function (GeneralSettings $settings) {
                return $settings->app_name ?? 'Tasawk';
            })
